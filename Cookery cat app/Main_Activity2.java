...
String[] items = new String[]{"Indian", "Chinese",
"Italian","Continental","Oriental"};
//create an adapter to describe how the items are displayed, adapters are used in
several places in android.
...
PutData putData = new
PutData("https://cookhousepanda.herokuapp.com/dish.php", "POST", key, value);
if (putData.startPut()) {
if (putData.onComplete()) {
String check = putData.getResult();
if (check.equals("Incorrect Ingredients or Dishes for selected
